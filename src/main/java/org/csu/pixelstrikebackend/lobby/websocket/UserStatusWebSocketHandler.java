...
public class UserStatusWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        if (userId != null) {
            ...
            ConcurrentWebSocketSessionDecorator concurrentSession = new ConcurrentWebSocketSessionDecorator(session, 2000, 1024 * 64);

            sessionManager.addSession(userId, concurrentSession);
        } else {
